...
public:
    ...
    void generateQueryMod( InputQuery &inputQuery, unsigned alpha );
    void generateQueryAnagha( InputQuery &inputQuery);
...
private:
    ...
    Map<NodeIndex, unsigned> _dupnodeToB;
    Map<NodeIndex, unsigned> _dupnodeToF;
};
