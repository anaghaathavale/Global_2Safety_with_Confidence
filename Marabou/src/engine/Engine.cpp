...
void Engine::invokePreprocessor( const InputQuery &inputQuery, bool preprocess ) //called
{
    if ( _verbosity > 0 )
    {   printf( "heyyyyyEngine::processInputQuery: Input query (before preprocessing): "
