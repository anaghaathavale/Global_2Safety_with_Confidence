...
void Marabou::prepareInputQuery()
{
    ...
    else
    {
        ...
        */
        ...
        _inputQuery.setLowerBound(0,9.0);
        _inputQuery.setUpperBound(0,9.0);
        _inputQuery.setLowerBound(1,-10.0);
        _inputQuery.setUpperBound(1,-10.0);
        _inputQuery.setLowerBound(2,9.0);
        _inputQuery.setUpperBound(2,9.0);
        _inputQuery.setLowerBound(3,-10.0);
        _inputQuery.setUpperBound(3,-10.0);*/
...
//            _inputQuery.addPiecewiseLinearConstraint(max1);
	    ...
	    _inputQuery.setUpperBound(var2,1000.0);
            ...
            _inputQuery.setUpperBound(conf1,0.5);
            _inputQuery.setLowerBound(conf1,0.5);
