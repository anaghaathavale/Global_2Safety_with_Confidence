...
void Marabou::prepareInputQuery()
{
    ...
    //            inputDistSet1.insert(aa);
		...
		//MaxConstraint *max_input_dist_ = new MaxConstraint(max_input_dist, inputDistSet1);
                ...
                /*input distance*/
                equation9.setScalar(epsilon_from_user);//input_dist
    ...
    //float kappa_plus_b = conf_from_user - 0.1717 + FLT_MIN;
    float kappa_plus_b = conf_from_user + FLT_MIN; 
    //float kappa_plus_b = 0.5 + FLT_MIN; 	
    /*confidence*/
    //equation5.setScalar(0.65);
    equation5.setScalar(kappa_plus_b); 
   _inputQuery.addEquation(equation5);
        

    Equation equation6(Equation::GE);
    float half = 0.5 + FLT_MIN;
    //Equation equation6;
    equation6.addAddend(1, max_conf1);
    /*confidence*/
    equation6.setScalar(half);
...
//Query1
    ...
    equation76.addAddend(-1, *outSet1.begin() + 1);
    equation76.setScalar(0.1);
    ...
    equation77.addAddend(-1, *outSet2.begin() + 1);
