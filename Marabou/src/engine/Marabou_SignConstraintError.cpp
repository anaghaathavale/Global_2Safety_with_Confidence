...
void Marabou::prepareInputQuery()
{
    ...
    else
    {
        ...
        */
        ...
        _inputQuery.setUpperBound(sign_var, -10);
        _inputQuery.setLowerBound(sign_var, -10);  
        unsigned sign_result = _inputQuery.getNumberOfVariables();
        _inputQuery.setNumberOfVariables(sign_result+1);
        _inputQuery.setUpperBound(sign_result, 100);
        _inputQuery.setLowerBound(sign_result, -100);  
        ...
        equation__10.addAddend(1,sign_result);
