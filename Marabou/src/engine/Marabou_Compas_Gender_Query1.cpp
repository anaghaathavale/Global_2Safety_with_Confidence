...
void Marabou::prepareInputQuery()
{
    ...
    else
    {
        ...
        */
        ...
        _inputQuery.setLowerBound(11,-1.0);
       ...
       // {
...

            {
                ...
                { 
                    ...
                    equation4.setScalar(0.9);
                    _inputQuery.addEquation(equation4);*/ //reb
    ...
    //            inputDistSet1.insert(aa);
                ...
                _inputQuery.addEquation(equation44);*/ //reb

		        Equation equation44(Equation::GE);
                equation44.addAddend(1, max_conf1);
                equation44.setScalar(conf_from_user);
