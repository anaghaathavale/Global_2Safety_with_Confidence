...
#ifndef __MinConstraint_h__
#define __MinConstraint_h__

#include "PiecewiseLinearConstraint.h"
#include "LinearExpression.h"
#include "Map.h"

#define MIN_VARIABLE_TO_PHASE_OFFSET 1

class MinConstraint : public PiecewiseLinearConstraint
{
public:
    ~MinConstraint();
    ...
    /*
      ...
      f = max( elements )
    */
    MinConstraint( unsigned f, const Set<unsigned> &elements );
    MinConstraint( const String &serializedMin );
...
private:
    ...
    */
    ...
    double _minValueOfEliminatedPhases;
    ...
    */
    inline PhaseStatus variableToPhase( unsigned variable ) const
    {
        return ( variable == MAX_PHASE_ELIMINATED )
                 ...
                 : static_cast<PhaseStatus>( variable + MIN_VARIABLE_TO_PHASE_OFFSET );
    }

    inline unsigned phaseToVariable( PhaseStatus phase ) const
    {
        return ( phase == MIN_PHASE_ELIMINATED )
                 ? MIN_PHASE_ELIMINATED
                 : static_cast<unsigned>( phase ) - MIN_VARIABLE_TO_PHASE_OFFSET;
    }
