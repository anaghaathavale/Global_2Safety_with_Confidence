...
filename = "/home/ubuntu/frozen_models/frozen_graph.pb"
...
network.setLowerBound(network.inputVars[0][0][0],-10.0)
network.setUpperBound(network.inputVars[0][0][0], 10.0)
network.setLowerBound(network.inputVars[0][0][1],-10.0)
network.setUpperBound(network.inputVars[0][0][1], 10.0)
network.setLowerBound(network.inputVars[1][0][0],-10.0)
network.setUpperBound(network.inputVars[1][0][0], 10.0)
network.setLowerBound(network.inputVars[1][0][1],-10.0)
network.setUpperBound(network.inputVars[1][0][1], 10.0)
...
network.setLowerBound(network.outputVars[1][0][0], 0.0)
network.setUpperBound(network.outputVars[1][0][0], 100.0)
